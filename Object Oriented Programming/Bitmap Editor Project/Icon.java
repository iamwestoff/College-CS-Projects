...
public class Icon {
    private final ArrayList<ArrayList<Pixel>> pixelSquare;
    ...
    // update--used for creating another instance
    public int getRowCount() {
        return pixelSquare.size();
    }

    public int getColumnCount() {
        // Assuming all rows have the same number of columns
        return pixelSquare.isEmpty() ? 0 : pixelSquare.get(0).size();
    }
